...
import { minLengthValidation, emailValidation, passwordValidation, requiredValidation } from "../utility/fieldValidation";
...
const SignUp = () => {
    ...
    const formFields = [
        {label: "First Name", type: "text", name: "firstName", validation: minLengthValidation},
        {label: "Last Name", type: "text", name: "lastName", validation: minLengthValidation},
        {label: "Email", type: "email", name: "email", validation: emailValidation},
        {label: "Password", type: "password", name: "password", validation: passwordValidation},
        {label: "Confirm Password", type: "password", name: "confirmPassword", validation: requiredValidation},
      ];
    ...
    const onSubmit = async(input, e) => {
        ...
        try {
            await addData("https://kahpehbini-fgd4zefew-glays-projects.vercel.app/api/v1/users/register", data);
    ...
    return (
        <div className="flex h-screen">
            <div className="w-full bg-yellow-50 flex items-center justify-center">
                <div className="max-w-md w-full p-6">
                    <h1 className="text-3xl font-semibold mt-10 mb-6 text-black text-center">Sign Up</h1>
                    <h1 className="text-sm font-semibold mb-6 text-gray-500 text-center">Welcome to Kah-peh Bini! </h1>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                        <div className="flex gap-5 mt-5">
                            {
                                formFields.filter(field => field.type === "text").map(field => (
                                    <SignUpFields
                                        key={field.name}
                                        field={field}
                                        register={register}
                    ...
                    <div className="mt-4 text-sm text-gray-600 text-center">
                        <p>Already have an account? <Link to="/signin" class="text-black hover:underline">Login here</Link>
                        </p>
                    </div>
                </div>
            </div>
